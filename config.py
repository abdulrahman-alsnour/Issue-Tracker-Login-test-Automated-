...
TICKET_TITLE = "Automation Ticket97"  # CHANGE: unique per run (avoid duplicate ticket)
...
TICKET_AGENT_TITLE = "Automation Ticket Agent72"  # CHANGE: unique per run (agent creates 2nd ticket)
