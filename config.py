...
NEW_USER_FOR_MANAGEMENT_TEST = {
    "user_name": "test.auto.admin81",  # CHANGE: unique per run (avoid "already exists")
    "first_name": "Test",
    "last_name": "Automation",
    "email": "test.auto.admin81@example.com",  # CHANGE: unique per run (match user_name)
...
UPDATED_USER_FOR_EDIT_TEST = {
    "user_name": "test.auto.edited30",  # CHANGE: unique per run (avoid "already exists")
    "first_name": "Edited",
    "last_name": "User",
    "email": "test.auto.edited30@example.com",  # CHANGE: unique per run (match user_name)
    "role": "Agency",
}
...
NEW_PROJECT_NAME = "Abdulrahman-project98"  # CHANGE: unique per run (avoid duplicate project)
EDIT_PROJECT_NAME = "Abdulrahman-project99"  # CHANGE: unique per run (edit target)
